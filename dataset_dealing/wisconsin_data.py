...
data_list = torch.load("../dataset/wisconsin_pyg.pt")
save_path = "../dataset/wisconsin/"
...
query_file=open(save_path + "wisconsin.query","w")
gt_file = open(save_path + "wisconsin.gt", "w")
...
edge_file = open(save_path + "wisconsin.edges", "w")
