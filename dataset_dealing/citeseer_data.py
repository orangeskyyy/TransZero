...
data_list = torch.load("../dataset/citeseer_pyg.pt")
save_path = "../dataset/citeseer/"
...
query_file=open(save_path + "citeseer.query","w")
gt_file = open(save_path + "citeseer.gt", "w")
...
edge_file = open(save_path + "citeseer.edges", "w")
