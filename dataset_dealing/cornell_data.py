...
data_list = torch.load("../dataset/cornell_pyg.pt")
save_path = "../dataset/cornell/"
labels = data_list[2]
torch.manual_seed(0)
...
query_file=open(save_path + "cornell.query","w")
gt_file = open(save_path + "cornell.gt", "w")
...
edge_file = open(save_path + "cornell.edges", "w")
