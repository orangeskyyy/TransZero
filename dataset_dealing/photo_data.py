...
data_list = torch.load("../dataset/photo_dgl.pt")
save_path = "../dataset/photo/"
...
query_file=open(save_path + "photo.query","w")
gt_file = open(save_path + "photo.gt", "w")
...
edge_file = open(save_path + "photo.edges", "w")
