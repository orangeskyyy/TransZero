...
data_list = torch.load("../dataset/dblp_pyg.pt")
save_path = "../dataset/dblp/"
...
query_file=open(save_path + "dblp.query","w")
gt_file = open(save_path + "dblp.gt", "w")
...
edge_file = open(save_path + "dblp.edges", "w")
